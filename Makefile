...
LIBS =pthread
DEPS = 
# Add any additional objects to this list TODO: add b_io.o to end of line directly below
ADDOBJ= fsInit.o bitMap.o rootDirectory.o volumeControlBlock.o mfs.o b_io.o 
ARCH = $(shell uname -m)
